	    ...
	    <c:import url="/WEB-INF/jsp/include/header.jsp" />
	    	...
	    	<div class="hero" id="home">
	        	<div class="text container align-baseline">
		          ...
		          <div>
			      	<a class="w3-btn w3-round-large w3-vivid-orange-yellow w3-hover-deep-orange" href="#services">수동시간표 생성</a>
			      	<a class="w3-btn w3-round-large w3-safety-blue w3-hover-blue" href="#services">자동시간표 생성</a>
		          </div>
		        </div>
	      </div>
